...
class __TwigTemplate_54b7869c3c96a7ccf2fdbaf3920ea16b extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 8 %}{% set filter_overview_topic = render_var(help_topic_link('filter.overview')) %}
...
</ol>", "@help_topics/editor.overview.html.twig", "/var/www/html/training-drupal/web/core/modules/editor/help_topics/editor.overview.html.twig");
    }
