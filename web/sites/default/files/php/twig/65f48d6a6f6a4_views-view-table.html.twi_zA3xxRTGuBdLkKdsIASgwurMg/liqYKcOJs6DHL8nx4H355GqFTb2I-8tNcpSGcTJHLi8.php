...
class __TwigTemplate_3835266bcf9560df281437d21a1b4607 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 35
        $context["classes"] = [("cols-" . twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(        // line 36
...
($context["fields"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["key"]] ?? null) : null), 62, $this->source))];
                ...
                // line 66
                echo "          <th";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["column"], "attributes", [], "any", false, false, true, 66), "addClass", [($context["column_classes"] ?? null)], "method", false, false, true, 66), "setAttribute", ["scope", "col"], "method", false, false, true, 66), 66, $this->source), "html", null, true);
                echo ">";
                // line 67
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["column"], "default_classes", [], "any", false, false, true, 91)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                        // line 98
                        echo "              ";
                        $context["column_classes"] = twig_array_merge($this->sandbox->ensureToStringAllowed(($context["column_classes"] ?? null), 98, $this->source), [("views-field-" . $this->sandbox->ensureToStringAllowed($context["field"], 98, $this->source))]);
                        // line 99
                        echo "            ";
                    }
                    $_parent = $context['_parent'];
                ...
                // line 101
                echo "          <td";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["column"], "attributes", [], "any", false, false, true, 101), "addClass", [($context["column_classes"] ?? null)], "method", false, false, true, 101), 101, $this->source), "html", null, true);
                echo ">";
                // line 102
...
", "core/themes/stable9/templates/views/views-view-table.html.twig", "/var/www/html/training-drupal/web/core/themes/stable9/templates/views/views-view-table.html.twig");
    }
