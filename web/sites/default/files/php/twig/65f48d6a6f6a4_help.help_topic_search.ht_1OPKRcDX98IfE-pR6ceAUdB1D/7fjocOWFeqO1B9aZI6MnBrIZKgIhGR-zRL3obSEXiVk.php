...
class __TwigTemplate_ae293c9bb48d26ebd431fca5189a5b25 extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 9 %}{% set extend_link_text %}{% trans %}Extend{% endtrans %}{% endset %}
...
</ol>", "@help_topics/help.help_topic_search.html.twig", "/var/www/html/training-drupal/web/core/modules/help/help_topics/help.help_topic_search.html.twig");
    }
