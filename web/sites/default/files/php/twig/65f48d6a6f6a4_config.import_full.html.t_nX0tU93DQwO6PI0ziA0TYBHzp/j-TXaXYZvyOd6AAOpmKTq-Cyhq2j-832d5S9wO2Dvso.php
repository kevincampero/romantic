...
class __TwigTemplate_2dc4c95961534fc6ab4560ddaea93cfe extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 9 %}{% set import_link_text %}{% trans %}Import{% endtrans %}{% endset %}
...
</ol>", "@help_topics/config.import_full.html.twig", "/var/www/html/training-drupal/web/core/modules/config/help_topics/config.import_full.html.twig");
    }
