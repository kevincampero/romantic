...
class __TwigTemplate_b59ed7f35c887a4b88a675016ec74d09 extends Template
{
    private $source;
    private $macros = [];
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-paths.html\">";
    ...
    {
        return new Source("{% line 8 %}<h2>{% trans %}What is a URL?{% endtrans %}</h2>
...
</ul>", "@help_topics/path.overview.html.twig", "/var/www/html/training-drupal/web/core/modules/path/help_topics/path.overview.html.twig");
    }
