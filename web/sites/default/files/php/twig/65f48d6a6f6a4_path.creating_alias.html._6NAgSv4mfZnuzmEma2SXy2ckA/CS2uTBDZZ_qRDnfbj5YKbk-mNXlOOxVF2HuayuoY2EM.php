...
class __TwigTemplate_ac643f30b55539f7d7ac3b435d9cd7e1 extends Template
{
    private $source;
    private $macros = [];
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-create.html\">";
    ...
    {
        return new Source("{% line 9 %}{% set path_permissions_link_text %}
...
</ul>", "@help_topics/path.creating_alias.html.twig", "/var/www/html/training-drupal/web/core/modules/path/help_topics/path.creating_alias.html.twig");
    }
