...
class __TwigTemplate_2c1d0da40a0cfee5d0c75dbc7ee2a7ac extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}The core User module allows users to register, log in, and log out, and administrators to manage user roles and permissions. The core Ban module allows administrators to ban certain IP addresses from accessing the site. Depending on which modules you have installed on your site, the related topics below will help you with tasks related to managing user accounts and visitors.{% endtrans %}</p>", "@help_topics/user.overview.html.twig", "/var/www/html/training-drupal/web/core/modules/user/help_topics/user.overview.html.twig");
    }
