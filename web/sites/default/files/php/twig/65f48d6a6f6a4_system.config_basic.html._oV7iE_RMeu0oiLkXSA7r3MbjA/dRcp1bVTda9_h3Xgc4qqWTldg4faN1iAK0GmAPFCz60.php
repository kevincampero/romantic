...
class __TwigTemplate_7e5587011feb7ef1d2ca93dd44c69305 extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}<a href=\"https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters\">PHP date format codes reference</a>{% endtrans %}</p>", "@help_topics/system.config_basic.html.twig", "/var/www/html/training-drupal/web/core/modules/system/help_topics/system.config_basic.html.twig");
    }
