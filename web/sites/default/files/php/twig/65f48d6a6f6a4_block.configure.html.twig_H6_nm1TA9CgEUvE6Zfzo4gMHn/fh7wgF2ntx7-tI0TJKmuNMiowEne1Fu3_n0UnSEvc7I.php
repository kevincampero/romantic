...
class __TwigTemplate_83ed614528695bc0764c7876ae459e2e extends Template
{
    private $source;
    private $macros = [];
...
<li>";
  ...
  <li>";
    ...
    {
        return new Source("{% line 7 %}{% set layout_link_text %}{% trans %}Block layout{% endtrans %}{% endset %}
...
</ol>", "@help_topics/block.configure.html.twig", "/var/www/html/training-drupal/web/core/modules/block/help_topics/block.configure.html.twig");
    }
