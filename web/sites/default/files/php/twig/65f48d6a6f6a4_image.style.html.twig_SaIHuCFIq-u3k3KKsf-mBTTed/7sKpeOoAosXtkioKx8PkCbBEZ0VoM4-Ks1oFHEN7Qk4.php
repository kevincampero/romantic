...
class __TwigTemplate_bf12be25c2a9b3c1a87f6dea5fbe4398 extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 8 %}{% set media_topic = render_var(help_topic_link('core.media')) %}
...
</ol>", "@help_topics/image.style.html.twig", "/var/www/html/training-drupal/web/core/modules/image/help_topics/image.style.html.twig");
    }
