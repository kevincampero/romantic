...
class __TwigTemplate_185e37f92901d55646f37af17e9d2c93 extends Template
{
    private $source;
    private $macros = [];
...
<ul>
  <li>";
    ...
    {
        return new Source("{% line 11 %}{% set content_structure_topic = render_var(help_topic_link('core.content_structure')) %}
...
</ul>", "@help_topics/core.media.html.twig", "/var/www/html/training-drupal/web/core/modules/help/help_topics/core.media.html.twig");
    }
