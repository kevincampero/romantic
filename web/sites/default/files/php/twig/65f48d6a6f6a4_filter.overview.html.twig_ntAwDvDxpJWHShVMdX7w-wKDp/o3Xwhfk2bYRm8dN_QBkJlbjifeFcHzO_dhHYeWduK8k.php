...
class __TwigTemplate_a66ba53d2683c137ff47e54aac416039 extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 10 %}{% set overview_link_text %}{% trans %}Text formats and editors{% endtrans %}{% endset %}
...
</ol>", "@help_topics/filter.overview.html.twig", "/var/www/html/training-drupal/web/core/modules/filter/help_topics/filter.overview.html.twig");
    }
