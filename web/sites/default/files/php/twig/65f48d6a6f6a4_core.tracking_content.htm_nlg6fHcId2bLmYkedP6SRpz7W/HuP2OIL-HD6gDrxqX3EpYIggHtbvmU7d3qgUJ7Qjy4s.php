...
class __TwigTemplate_fe7b5be8f23db1e56df8852c67c3c173 extends Template
{
    private $source;
    private $macros = [];
...
<p>";
    ...
    {
        return new Source("{% line 5 %}<h2>{% trans %}Tracking overview{% endtrans %}</h2>
...
<p>{% trans %}If you have one or more tracking modules installed on your site, see the related topics listed below for specific tasks.{% endtrans %}</p>", "@help_topics/core.tracking_content.html.twig", "/var/www/html/training-drupal/web/core/modules/help/help_topics/core.tracking_content.html.twig");
    }
