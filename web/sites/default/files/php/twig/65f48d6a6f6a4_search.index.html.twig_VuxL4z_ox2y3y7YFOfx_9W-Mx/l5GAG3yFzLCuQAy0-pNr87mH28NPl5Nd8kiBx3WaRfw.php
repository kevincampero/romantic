...
class __TwigTemplate_01820a71b739184fbb876b830ad73ea4 extends Template
{
    private $source;
    private $macros = [];
...
<li>";
    ...
    {
        return new Source("{% line 7 %}{% set cron_topic = render_var(help_topic_link('core.cron')) %}
...
</ol>", "@help_topics/search.index.html.twig", "/var/www/html/training-drupal/web/core/modules/search/help_topics/search.index.html.twig");
    }
